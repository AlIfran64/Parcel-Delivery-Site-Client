  ...
  return (
    <div className="navbar bg-base-100 shadow-sm py-3">
      <div className="navbar-start">
        ...
        {/* LOGO */}
        <div className='ml-4 flex justify-start items-end relative'>
          <img className='h-9 lg:h-10' src={logo} alt="logo" />
          <h1 className='text-xl lg:text-3xl font-extrabold absolute left-4 top-3'>Profast</h1>
        </div>
      </div>
      ...
      <div className="navbar-end space-x-4 mr-4">
        <button className="py-2 px-4 border border-[#DADADA] rounded-xl font-semibold hover:bg-[#606060] hover:text-white">Sign in</button>
        <button className="py-2 px-4 border border-[#CAEB66] bg-[#CAEB66] rounded-xl font-semibold hover:bg-[#1F1F1F] hover:text-white">Sign up</button>
      </div>
    </div>
  );
};
